...
(
    ...
    enqueued_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),                  -- When the job was enqueued (never changes)
    process_at  TIMESTAMPTZ NOT NULL DEFAULT NOW()                   -- When the job should be run (updates every retry)
);
